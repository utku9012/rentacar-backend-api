...
output "private_db_subnet_ids" { value = module.networking.private_db_subnet_ids }
...
output "github_actions_ecr_role_arn" { value = module.github_oidc.github_ecr_publisher_role_arn }
